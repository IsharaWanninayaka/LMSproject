        ...
        <div className='all-box'>
            ...
            <div class='flex flex-col gap-[1px] items-center'>
              ...
              <div className=" w-[266px] bg-[rgb(25,31,92)] h-[39px]  rounded-[39px]  mt-4 ">
                ...
                <div className='text-white '><Link to='/course/grade11lesson1' className=''><p className='mt-[12px] text-[9px] ml-13'>Programming - ක්‍රමලේඛනය </p></Link></div>
              ...
              <div className=" w-[266px] bg-[rgb(25,31,92)] h-[39px]  rounded-[39px]  mt-4 ">
                ...
                <div className='text-white '><Link to='/course/grade11lesson2' className=''><p className='mt-[7px] text-[9px] ml-13'>System Development Life - පද්ධති සංවර්ධන ජීවන චක්‍රය </p></Link></div>
              ...
              <div className=" w-[266px] bg-[rgb(25,31,92)] h-[39px]  rounded-[39px]  mt-4 ">
                ...
                <div className='text-white '><Link to='/course/grade11lesson3' className=''><p className='mt-[7px] text-[9px] ml-13'>The Internet and the Electronic - අන්තර්ජාලය සහ ඉලෙක්ට්‍රොනික තැපෑල </p></Link></div>
              ...
              <div className=" w-[266px] bg-[rgb(25,31,92)] h-[39px]  rounded-[39px]  mt-4 ">
                ...
                <div className='text-white '><Link to='/course/grade11lesson4' className=''><p className='mt-[12px] text-[9px] ml-13'>Use of Multimedia - බහුමාධ්‍ය භාවිතය</p></Link></div>
              ...
              <div className=" w-[266px] bg-[rgb(25,31,92)] h-[39px]  rounded-[39px]  mt-4 ">
                ...
                <div className='text-white '><Link to='/course/grade11lesson5' className=''><p className='mt-[7px] text-[9px] ml-13'>Web Designing Using Multimedia - බහුමාධ්‍ය භාවිතයෙන් වෙබ් නිර්මාණකරණය </p></Link></div>
              ...
              <div className=" w-[266px] bg-[rgb(25,31,92)] h-[39px]  rounded-[39px]  mt-4 ">
                ...
                <div className='text-white '><Link to='/course/grade11lesson6' className=''><p className='mt-[2px] text-[9px] ml-13 leading-3'>Information and Communication Technology and Society - තොරතුරු සහ සන්නිවේදන තාක්ෂණය සහ සමාජය</p></Link></div>
              </div>
