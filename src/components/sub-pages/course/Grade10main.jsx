        ...
        <div className='all-box'>
            ...
            <div class='flex flex-col gap-[1px] items-center'>
              ...
              <div className=" w-[266px] bg-[rgb(25,31,92)] h-[39px]  rounded-[39px]  mt-4 ">
                ...
                <div className='text-white '><Link to='/grade10lesson3' className=''><p className='mt-[4px] text-[9px] ml-14 leading-3'>Data Representation Methods in the Computer system - පරිගණක පද්ධතියේ දත්ත නියෝජන ක්‍රම</p></Link></div>
              </div>
