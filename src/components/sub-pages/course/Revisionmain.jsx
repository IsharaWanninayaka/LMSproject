        ...
        <div className='all-box'>
            ...
            <div class='flex flex-col gap-[1px] items-center'>
              ...
              <div className=" w-[266px] bg-[rgb(25,31,92)] h-[39px]  rounded-[39px]  mt-4 ">
                ...
                <div className='text-white '><Link to='/grade10lesson1' className=''><p className='mt-[7px] text-[9px] ml-14'>Data Representation Methods in the Computer system -</p></Link></div>
              ...
              <div className=" w-[266px] bg-[rgb(25,31,92)] h-[39px]  rounded-[39px]  mt-4 ">
                ...
                <div className='text-white '><Link to='/grade10lesson2' className=''><p className='mt-[7px] text-[9px] ml-14'>Logic Gates with Boolean Functions - </p></Link></div>
              ...
              <div className=" w-[266px] bg-[rgb(25,31,92)] h-[39px]  rounded-[39px]  mt-4 ">
                ...
                <div className='text-white '><Link to='/grade10lesson3' className=''><p className='mt-[7px] text-[9px] ml-14'>Operating Systems -</p></Link></div>
              ...
              <div className=" w-[266px] bg-[rgb(25,31,92)] h-[39px]  rounded-[39px]  mt-4 ">
                ...
                <div className='text-white '><Link to='/grade10lesson4' className=''><p className='mt-[7px] text-[9px] ml-14'>Electronic Spreadsheet -</p></Link></div>
              ...
              <div className=" w-[266px] bg-[rgb(25,31,92)] h-[39px]  rounded-[39px]  mt-4 ">
                ...
                <div className='text-white '><Link to='/grade10lesson5' className=''><p className='mt-[11px] text-[9px] ml-14'>Database -</p></Link></div>
              ...
              <div className=" w-[266px] bg-[rgb(25,31,92)] h-[39px]  rounded-[39px]  mt-4 ">
                ...
                <div className='text-white '><Link to='/grade10lesson6' className=''><p className='mt-[11px] text-[9px] ml-14'>Programming -</p></Link></div>
              ...
              <div className=" w-[266px] bg-[rgb(25,31,92)] h-[39px]  rounded-[39px]  mt-4 ">
                ...
                <div className='text-white '><Link to='/grade10lesson7' className=''><p className='mt-[7px] text-[9px] ml-14'>System Development Life -</p></Link></div>
              ...
              <div className=" w-[266px] bg-[rgb(25,31,92)] h-[39px]  rounded-[39px]  mt-4 ">
                ...
                <div className='text-white '><Link to='/grade10lesson8' className=''><p className='mt-[7px] text-[9px] ml-14'>The Internet and the Electronic - </p></Link></div>
              ...
              <div className=" w-[266px] bg-[rgb(25,31,92)] h-[39px]  rounded-[39px]  mt-4 ">
                ...
                <div className='text-white '><Link to='/grade10lesson9' className=''><p className='mt-[11px] text-[9px] ml-14'>Web Designing Using Multimedia - </p></Link></div>
