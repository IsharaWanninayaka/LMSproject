    ...
    <div>
      <div class='flex flex-col gap-[1px] items-center'>
        <div className=" w-[266px] bg-[rgb(25,31,92)] h-[39px]  rounded-[39px]  mt-4 ">
            ...
            <div className='text-white '><Link><p className='mt-[11px] text-[9px] ml-14'>Operating Systems - මෙහෙයුම් පද්ධති</p></Link></div>
        </div>
      </div>
    </div>
...
export default Grade10lesson05