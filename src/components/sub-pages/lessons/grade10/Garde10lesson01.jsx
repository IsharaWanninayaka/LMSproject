      ...
      <div>
        <div class='flex flex-col gap-[1px] items-center'>
          <div className=" w-[266px] bg-[rgb(25,31,92)] h-[39px]  rounded-[39px]  mt-4 ">
              ...
              <div className='text-white '><Link><p className='mt-[7px] text-[9px] ml-14'>Information and Communication - තොරතුරු හා සන්නිවේදන තාක්ෂණය</p></Link></div>
          </div>
        </div>
      </div>
...
export default Garde10lesson01