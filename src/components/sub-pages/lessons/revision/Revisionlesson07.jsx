    ...
    <div>
      <div class='flex flex-col gap-[1px] items-center'>
        <div className=" w-[266px] bg-[rgb(25,31,92)] h-[39px]  rounded-[39px]  mt-4 ">
            ...
            <div className='text-white '><Link><p className='mt-[8px] text-[9px] ml-13 leading-3'> System Development Life - පද්ධති සංවර්ධන ජීවන චක්‍රය </p></Link></div>
        </div>
      </div>
    </div>
...
export default Revisionlesson07