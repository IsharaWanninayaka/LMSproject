...
function AdminRegister() {
  return (
    ...
    <form action=''>
      <div className='flex flex-col w-[346px] h-[410px] m-auto bg-[rgb(25,31,92)] mt-[130px] rounded-[28px]'>
        ...
        <div>
            <p className='text-white text-[10px]  text-center mt-4'>Already have an account? <Link to="/adminlogin" ><p className='text-yellow-300 underline underline-offset-1'>Login</p></Link></p>
        </div>
